...
void main() {
  ...
  unit.group('A group of tests', () {
    unit.test("decode/encode", () {
      ...
      return TMessageRequest.decode(parser).then((TMessageRequest message) {
    ...
    unit.test("encode", () {
      EasyParser parser = new EasyParser(builder);
      TMessageRequest message = new TMessageRequest(10,100,10300);
    ...
    unit.test("error", () {
      ...
      TMessageRequest.decode(parser).then((_) {
